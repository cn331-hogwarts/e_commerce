            ...
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
                    <Link to="/home" className="flex items-center space-x-3 rtl:space-x-reverse">
                        <img src="https://www.mobafire.com/images/champion/square/irelia.png" className="h-8" alt="Flowbite Logo" />
                ...
                <div className="max-w-screen-xl px-4 py-3 mx-auto">
                    <div className="flex items-center">
                        <ul className="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
                            ...
                            <li>
                                <Link to="/menus" className="text-gray-900 dark:text-white hover:underline">Menus</Link>
                            </li>
                            <li>
                                <Link to="/blog" className="text-gray-900 dark:text-white hover:underline">Blog/article</Link>
                            </li>
                            <li>
